...
<head lang="en">
    ...
    <script src="/kedo/Public/live/js/sea-modules/radialIndicator-master/radialIndicator.js"></script>
    <script src="/kedo/Public/live/js/sea-modules/jquery.nicescroll-master/jquery.nicescroll.min.js"></script>
    <script src="/kedo/Public/live/js/sea-modules/seajs/seajs/3.0.0/sea.js"></script>
    <!--[if IE]>
    <link rel="stylesheet" type="text/css" href="http://www.zhangxinxu.com/study/down/ie-css3.htc" />
    <![endif]-->

    <link rel="stylesheet" type="text/css" href="/kedo/Public/live/css/buttons.css" />
    <link rel="stylesheet" type="text/css" href="/kedo/Public/live/js/sea-modules/jquery-ui-master/jquery-ui.min.css" />
    <link rel="stylesheet" href="/kedo/Public/live/js/sea-modules/jquery-ui-master/jquery-splitter.base.css" type="text/css" />
    <link href="/kedo/Public/live/css/login.css?v=<?php echo $vsn;?>" type="text/css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        var UIF = {
            ...
            init : function(){
                seajs.config({
                    base : "/kedo/Public/live/js/sea-modules/",
                    alias : {
...
<div class="nav-left">
    <div class="live-logo" style="width:70px;height:82px;background:url(/kedo/Public/live/skin/logo_zhibojian.png) no-repeat;position: absolute;top:8px;left:2px">
...
<div style="display:none">
    <?php
 foreach($giftId as $v){ if($v["giftcateid"]=="0" || $v["giftcateid"]=="1"){ ?>
...
<div class="newGifts" onselectstart="return false" >
    ...
    <div class="mainGifts" >
        <div class="giftHeader">
            <?php
 echo "<pre>"; echo "</pre>"; foreach($giftcate as $giftcateid=>$arr): if($giftcateid != 25){ $ac = ''; }else{ $ac = 'class="haselect"'; } ?>
        ...
        <div class="giftContents">
            <div class="giftwarp">
                <div class="inshaddow">
                    ...
                    <div class="giftLists">
                        <?php
 foreach($giftinfo as $cateid=>$gifts){ if(in_array($cateid, array("0","1","8","15")))continue; if($cateid==25){ $class='xGiftList'; }else{ $class=''; } echo '<ul id="giftList'.$cateid.'"  class="visualGiftList '.$class.'" >'; foreach($gifts as $gift){ $parm=json_decode($gift['parameters'],true); $join=$parm['join']?$parm['join']:0; ?>
                                <li class="<?php if($gift['catename'] == "背包"){ echo "hideli ";} echo $gift['giftid'];?>">
                                    <div price="<?php echo $gift['giftprice']?>" id="gift<?php echo $gift['giftid']?>" >
                                        <img src="<?php echo _IMAGES_DOMAIN_."/".$gift['giftimage'];?>?p=0" types="<?php echo $gift['giftType'];?>" join="<?php echo $join;?>" rel="<?php echo $gift['giftprice']; echo $page_var['money_name']?>" />
