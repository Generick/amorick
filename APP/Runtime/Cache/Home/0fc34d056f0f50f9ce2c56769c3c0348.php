...
<div class="head-outer btline">
    <div class="header clearFix">
        ...
        <div class="user clearFix">
            <div class="fl hd_hov">
                <a class="username fl" href="/kedo/index.php/Home/Trade/index"><?php echo ($use["nickName"]); ?></a>
...
<div class="inmiddle">
    <?php
 function getmonth(){ $monlist=""; $time = time(); $month = date('m',$time); for($m=1;$m<13;$m++){ if($m==$month){ $monlist.="<option selected = 'selected'>".$m."</option>"; }else{ $monlist.="<option>".$m."</option>"; } } return $monlist; } ?>
